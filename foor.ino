...
const uint8_t fingerprint[20] = {0xF1, 0x5F, 0x09, 0xCC, 0x9B, 0xC3, 0x97, 0x1D, 0x54, 0xE6, 0x8D, 0x0D, 0x04, 0xD2, 0x43, 0x83, 0x7E, 0xF3, 0x46, 0xD8};
...
void setup() {
  ...
  //WiFiMulti.addAP("TLU", "");
  WiFiMulti.addAP("Telia-9F2C92", "E5WONK2GZJNXNA");
